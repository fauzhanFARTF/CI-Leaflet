...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-dark"> <!-- Ganti White Menjadi Darl -->
    <div class="container">
        <a href="<?=base_url()?>assets/template/index3.html" class="navbar-brand">
            ...
            <span class="brand-text font-weight-light" style="color:gold">Geo-Info3</span>
        </a>
